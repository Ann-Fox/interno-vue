...
import { ref } from 'vue';
  const projects = [
           {  tag: 'Bedroom',
              ...
              urlImg: '/images/project-bedroom-1.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-2.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-3.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-4.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-5.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-6.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-7.jpg',
            },
            {  tag: 'Bedroom',
              head: 'Minimal Bedroom',
              urlImg: '/images/project-bedroom-8.jpg',
            },
            {  tag: 'Bathroom',
              head: 'Minimal Bathroom',
              urlImg: '/images/project-bedroom-3.jpg',
            },
            {  tag: 'Bathroom',
              head: 'Minimal Bathroom',
            ...
            <div class="project__item" v-for="project in currentContents" :key="project.tag">
                ...
                <div class="project__items__content">
                    <div class="project__items__text">
                        <h4 class="project__items__title">{{ project.head }}</h4>
...
.project__items__content {
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding-top: 47px;
}
.project__items__text {
  display: flex;
  justify-content: space-between;
